...
public class FastScroller {
    ...
    // Sisipan adalah buffer di mana suatu titik masih akan terdaftar sebagai klik pada bilah gulir
    private int mTouchInset;

    // Ini adalah offset dari bagian atas bilah gulir saat pengguna pertama kali mulai menyentuh. Ke
    // cegah lompatan, offset ini diterapkan saat pengguna menggulir.
    ...
    /**
     * Menangani acara sentuh dan menentukan apakah akan menampilkan penggulung cepat (atau memperbaruinya jika
     * sudah tayang).
     */
    public void handleTouchEvent(MotionEvent ev, int downX, int downY, int lastY,
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                // Periksa apakah kita harus mulai menggulir
