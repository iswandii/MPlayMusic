...
public class FastScrollPopup {
    ...
    // Batas mutlak dari fast scroller bg
    ...
    /**
     * Animasi visibilitas popup gulir cepat.
     */
    ...
    // Setter/getter untuk alpha popup untuk animasi
    @Keep
    ...
    public void setSectionName(String sectionName) {
        if (!sectionName.equals(mSectionName)) {
            ...
            // Perbarui lebar untuk menggunakan measureText karena lebih akurat
            mTextBounds.right = (int) (mTextBounds.left + mTextPaint.measureText(sectionName));
        }
    }

    /**
     * Memperbarui batas untuk penggulung cepat.
     *
     * @kembalikan rect pembatalan untuk pembaruan ini.
     */
...
// Gabungkan batas penggulung cepat lama dan baru untuk membuat kotak penuh yang tidak valid        mInvalidateRect.union(mBgBounds);
